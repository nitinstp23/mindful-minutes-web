        ...
        <section className="text-center mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">Track Sessions</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">View Progress</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">Stay Consistent</h3>
